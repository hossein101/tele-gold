...
local function run(msg, matches)
  if matches[1]:lower() == 'telegold' then -- Put everything you like :)
    local about = _config.about_text
    local name = user_print_name(msg.from)
    savelog(msg.to.id, name.." ["..msg.from.id.."] used /telegold ")
    return about
  end 
  ...
  if matches[1]:lower() == "آمار" or matches[1]:lower() == "stats" then
    ...
    if matches[2] == "telegold" then -- Put everything you like :)
